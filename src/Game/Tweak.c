...
//    makeEntry(tpGameCreated.resourceLumpSumAmount,      scriptSetUdwordCB),
    ...
    { "capShipLieFlatInGeneralDistanceTolerance[CLASS_HEAVY_CRUISER]",                 scriptSetReal32CB, &capShipLieFlatInGeneralDistanceTolerance[CLASS_HEAVY_CRUISER] },
    ...
    { "capShipLieFlatInGeneralDistanceTolerance[CLASS_NON_COMBAT]",                 scriptSetReal32CB, &capShipLieFlatInGeneralDistanceTolerance[CLASS_NON_COMBAT] },
    ...
    { "capShipLieFlatInGeneralSpeedSqrTolerance[CLASS_HEAVY_CRUISER]",                 scriptSetReal32SqrCB, &capShipLieFlatInGeneralSpeedSqrTolerance[CLASS_HEAVY_CRUISER] },
    ...
    { "capShipLieFlatInGeneralSpeedSqrTolerance[CLASS_NON_COMBAT]",                 scriptSetReal32SqrCB, &capShipLieFlatInGeneralSpeedSqrTolerance[CLASS_NON_COMBAT] },
